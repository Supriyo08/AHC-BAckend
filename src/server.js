...
// === MIDDLEWARE ===
app.use(cors({
  origin: ['https://ah-cv2-0-zw6n.vercel.app','https://ah-cv2-0-qqu3.vercel.app','https://ahc-admin-three.vercel.app','http://localhost:5173', 'http://localhost:3000'], // replace with actual domains
  methods: ['GET', 'POST'],
}));
